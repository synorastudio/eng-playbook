...
- Allows a draft Spec, unresolved decision, or a Work Unit the user has not released to reach production implementation, or lets an agent treat its own proposal or an accepted plan as the release.

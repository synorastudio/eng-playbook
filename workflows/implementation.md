...
Implementation turns the work the user asked to build into a verified production outcome while preserving the project's architecture, documentation, and Project Guardrails.
...
1. Inspect only the code, Agent Guidance, Language, ADRs, Living Docs, tracker context, and controls relevant to the work you were asked to build.
...
3. Implement the piece you were asked to build, choosing reversible technical details autonomously within the project's boundaries. Do not expand into other pieces that were planned but not asked for.
...
10. Resolve failures caused by the change and distinguish unrelated existing failures in the completion report.

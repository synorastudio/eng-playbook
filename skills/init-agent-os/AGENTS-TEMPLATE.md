...
- Use Linear as the issue tracker; it owns Decision Maps, Decision Issues, Specs, Feature Issues, and Sub-Issues. Issues represent user-recognizable features, not technical tasks. (Use the project's own tracker instead when it has one.)
